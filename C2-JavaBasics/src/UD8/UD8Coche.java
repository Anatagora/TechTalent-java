...
//		}
	...
	public static void main(String[] args) {
		...
		System.out.println("¿Cuál es la marca del miCoche?" + miCoche.marca + " " + miCoche.año + " " + miCoche.modelo
				+ " " + miCoche.color);
		UD8Coche ferrari = new UD8Coche();
		System.out.println("¿Cuál es la marca del Ferrari?" + ferrari.marca + ferrari.año + ferrari.modelo);
		UD8Coche coche3 = new UD8Coche("Opel");
		System.out.println("¿Cuál es la marca del coche3? " + coche3.marca + coche3.modelo + " " + coche3.año);
